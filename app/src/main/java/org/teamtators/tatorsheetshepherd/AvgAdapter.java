...
public class AvgAdapter extends ArrayAdapter<AvgView> {

    Context context;
    private ArrayList<AvgView> avgTeams;

    public AvgAdapter(Context context, int textViewResourceId, ArrayList<AvgView> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        AvgView o = avgTeams.get(position);
        if (o != null) {
